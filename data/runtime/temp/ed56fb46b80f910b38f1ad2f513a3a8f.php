<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1559215784;s:69:"/Users/haoming/work/dl/客户/大唐机械/new/template/pc/header.htm";i:1600844050;s:69:"/Users/haoming/work/dl/客户/大唐机械/new/template/pc/footer.htm";i:1559215784;}*/ ?>
  ...
  <div class="headerTop container">
    ...
    <div class="headRight">
      <ul>
        ...
        <li class="eyou-edit" e-id="h2" e-type="type"> <?php  $tagUitype = new \think\template\taglib\eyou\TagUitype; $__LIST__ = $tagUitype->getUitype("23","h2", "header"); if((is_array($__LIST__)) && (!empty($__LIST__["info"]) || (($__LIST__["info"] instanceof \think\Collection || $__LIST__["info"] instanceof \think\Paginator ) && $__LIST__["info"]->isEmpty()))): $field = $__LIST__;  $ui_typeid = !empty($field["info"]["typeid"]) ? $field["info"]["typeid"] : ""; if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("缺省文字");else: $field = $__LIST__;?><a href="<?php echo $field['typeurl']; ?>"><?php echo $field['typename']; ?></a><?php endif; else: echo htmlspecialchars_decode("缺省文字");endif; $field = []; $ui_typeid = ""; endif; ?></li>
        <li class="last eyou-edit" e-id="h3" e-type="type" > <?php  $tagUitype = new \think\template\taglib\eyou\TagUitype; $__LIST__ = $tagUitype->getUitype("24","h3", "header"); if((is_array($__LIST__)) && (!empty($__LIST__["info"]) || (($__LIST__["info"] instanceof \think\Collection || $__LIST__["info"] instanceof \think\Paginator ) && $__LIST__["info"]->isEmpty()))): $field = $__LIST__;  $ui_typeid = !empty($field["info"]["typeid"]) ? $field["info"]["typeid"] : ""; if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("缺省文字");else: $field = $__LIST__;?><a href="<?php echo $field['typeurl']; ?>"><?php echo $field['typename']; ?></a><?php endif; else: echo htmlspecialchars_decode("缺省文字");endif; $field = []; $ui_typeid = ""; endif; ?> </li>
      </ul>
      <div class="clear"></div>
      <div class="phone eyou-edit" e-id="h4" e-type="text">
       <?php  $tagUitext = new \think\template\taglib\eyou\TagUitext; $__LIST__ = $tagUitext->getUitext("h4", "header"); if((is_array($__LIST__)) && (!empty($__LIST__["value"]) || (($__LIST__["value"] instanceof \think\Collection || $__LIST__["value"] instanceof \think\Paginator ) && $__LIST__["value"]->isEmpty()))): $field = $__LIST__; ?>
      <?php echo $field['value']; else: ?>
      <p>全国加盟咨询热线：</p>
      <h3><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_1"); echo $__VALUE__; ?></h3>
      <?php endif; ?> </div>
  </div>
</div>
<div class="headerNav">
