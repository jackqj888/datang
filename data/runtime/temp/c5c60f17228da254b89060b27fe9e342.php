<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"./template/pc/lists_article_img.htm";i:1530671158;s:24:"./template/pc/header.htm";i:1600062948;s:22:"./template/pc/left.htm";i:1530670434;s:24:"./template/pc/footer.htm";i:1531819666;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="n-box"> <div class="n-l">
  ...
  <div class="n-r">
    ...
    <div class="n-tu">
      <ul>
        <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 16, "", "", "desc", "on","off");if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 40, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
        <li>
          <div class="c-tu"><a href="<?php echo $field['arcurl']; ?>"><img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" width="210" height="144"/></a></div>
          <div class="c-tit"><a href="<?php echo $field['arcurl']; ?>"><?php echo $field['title']; ?></a></div>
        </li>
        <?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
      </ul>
    </div>
    <div class="pageListNav">  <?php  $__PAGES__ = isset($__PAGES__) ? $__PAGES__ : ""; $tagPagelist = new \think\template\taglib\eyou\TagPagelist; $__VALUE__ = $tagPagelist->getPagelist($__PAGES__, "info,pre,next,pageno", "2"); echo $__VALUE__; ?> </div>
  </div>
</div>
<div class="foot-box">
  <div class="link-box">
