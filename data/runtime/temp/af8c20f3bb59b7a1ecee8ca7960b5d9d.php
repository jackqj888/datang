<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./application/admin/template/index\switch_map.htm";i:1599809783;s:70:"D:\phpEnv\www\other\jixie\application\admin\template\public\layout.htm";i:1599809783;s:70:"D:\phpEnv\www\other\jixie\application\admin\template\public\footer.htm";i:1525273455;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_pay_open" style="<?php if(!isset($userConfig['pay_open']) || empty($userConfig['pay_open'])): ?> display: none;<?php endif; ?>">
                    ...
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('System/api_conf'); ?>" data-leftmenu="Member_users_index" onclick="gourl2(this);">[接口配置]</a>
                </span>
            </dd>
        </dl>
        <dl class="row">
            ...
            <dd class="opt">
                <div class="onoff">
                    ...
                    <input id="shop_open1" name="shop[shop_open]" value="1" type="radio" <?php if($userConfig['shop_open'] == 1): ?> checked="checked"<?php endif; ?> data-authortoken="<?php echo $is_eyou_authortoken; ?>" data-is_online="<?php echo $is_online; ?>" onclick="ajax_submit(this, 'shop', 'shop_open');" data-lmenuid="Shop_home">
                    <input id="shop_open0" name="shop[shop_open]" value="0" type="radio" <?php if(!isset($userConfig['shop_open']) || empty($userConfig['shop_open'])): ?> checked="checked"<?php endif; ?> data-authortoken="<?php echo $is_eyou_authortoken; ?>" data-is_online="<?php echo $is_online; ?>" onclick="ajax_submit(this, 'shop', 'shop_open');" data-lmenuid="Shop_home">
                </div>
                ...
                <span id="guide_shop_open" style="<?php if(!isset($userConfig['shop_open']) || empty($userConfig['shop_open'])): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Shop/index'); ?>" data-leftmenu="Shop_home" onclick="gourl2(this);">[订单列表]</a>
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Shop/conf'); ?>" data-leftmenu="Shop_home" onclick="gourl2(this);">[功能配置]</a>
...
<!--         <dl class="row">
            ...
            <dd class="opt">
                <div class="onoff">
                    <label for="web_diyminipro_switch1" class="cb-enable <?php if(empty($globalConfig['web_diyminipro_switch']) || $globalConfig['web_diyminipro_switch'] == 1): ?>selected<?php endif; ?>">开启</label>
                    <label for="web_diyminipro_switch0" class="cb-disable <?php if(isset($globalConfig['web_diyminipro_switch']) && $globalConfig['web_diyminipro_switch'] == -1): ?>selected<?php endif; ?>">关闭</label>
                    <input id="web_diyminipro_switch1" name="web[web_diyminipro_switch]" value="1" type="radio" <?php if(empty($globalConfig['web_diyminipro_switch']) || $globalConfig['web_diyminipro_switch'] == 1): ?> checked="checked"<?php endif; ?> onclick="ajax_submit(this, 'web', 'web_diyminipro_switch');" data-lmenuid="Diyminipro_theme_index">
                    <input id="web_diyminipro_switch0" name="web[web_diyminipro_switch]" value="-1" type="radio" <?php if(isset($globalConfig['web_diyminipro_switch']) && $globalConfig['web_diyminipro_switch'] == -1): ?>selected<?php endif; ?> checked="checked"{/if} onclick="ajax_submit(this, 'web', 'web_diyminipro_switch');" data-lmenuid="Diyminipro_theme_index">
                </div>
                <p class="notic">开启之后，顶部菜单会显示小程序入口</p>
                <span id="guide_web_diyminipro_switch" style="<?php if(!empty($globalConfig['web_diyminipro_switch']) && $globalConfig['web_diyminipro_switch'] == -1): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="<?php echo url('Diyminipro/page_edit'); ?>">[进入后台]</a>
                </span>
            </dd>
        </dl> -->
        <?php endif; ?>
